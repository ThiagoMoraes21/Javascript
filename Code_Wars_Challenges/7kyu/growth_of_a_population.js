...
// refactoring
function nbYear_rec(p0, percent, aug, p) {
    let years = 0;
    while(p > p0) {
...
Test.assertEquals(nbYear_rec(1500, 5, 100, 5000), 15);
Test.assertEquals(nbYear_rec(1500000, 2.5, 10000, 2000000), 10);
Test.assertEquals(nbYear_rec(1500000, 0.25, 1000, 2000000), 94);